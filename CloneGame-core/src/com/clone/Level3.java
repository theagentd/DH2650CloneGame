...
public class Level3 {
	public Level3(World world) {
		...
		Utils.Column3(world, new Vector2(50+16*(GroundSquare.SCALE*60),160+4*(GroundSquare.SCALE*60)));
		...
		Utils.SpikeL5(world, new Vector2(23.95f+44*(GroundSquare.SCALE*30),78.9f+0*(GroundSquare.SCALE*30)));
		...
		Utils.Column3(world, new Vector2(50+49*(GroundSquare.SCALE*60),160+5*(GroundSquare.SCALE*60)));
